require 'rspec'
require 'date'
require_relative '../../../../../level5/app/strategies/actions/driver_calculator'
...
RSpec.describe DriverCalculator do
  describe '#calculate' do
    ...
    it 'calculates the driver amount correctly' do
      expect(driver_calculator.calculate_amount_without_options).to eq(2000 + 2000 * 2 * 0.9 + 10 * 150) # 3 days (2 at -10%), 150 km
    end
