require 'rspec'
require 'date'
require_relative '../../../../../level5/app/strategies/actions/insurance_calculator'
...
RSpec.describe InsuranceCalculator do
  describe '#calculate' do
    ...
    it 'calculates the insurance amount correctly' do
      ...
      expect(insurance_calculator.calculate_amount_without_options(
        {
          driver: { amount_without_options: 7500 }
        })).to eq(insurance_fee) # Half of the commission
    end
