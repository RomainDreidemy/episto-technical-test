require 'rspec'
require 'date'
require_relative '../../../../../level5/app/models/actions/debit_action'
...
RSpec.describe DebitAction do
  describe '#calculate_amount_without_options' do
    ...
    it 'calculates the correct options amount' do
      action = DebitAction.new(rental:, who: 'driver')
      expect(action.calculate_options_amount).to eq(5100) # 3 days * 1000 cents/day
    end
